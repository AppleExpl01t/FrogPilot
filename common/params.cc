...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"VisionSpeedLimitDetection", PERSISTENT},
    {"VisionSpeedLimit", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION | CLEAR_ON_OFFROAD_TRANSITION},
    {"VisionSpeedLimitStatus", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION | CLEAR_ON_OFFROAD_TRANSITION},
